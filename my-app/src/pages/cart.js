...
const CartPage = () => {
    ...
    const renderCartCard = () => cart.map((prod) => <CartCard key = {prod['_id']} id = {prod['_id']} title = {prod.title} price = {prod.price} qty = {prod.qty} category = {prod.category} rating = {prod.rating} author = {prod.author} thumbnail = {prod.thumbnail} />)
